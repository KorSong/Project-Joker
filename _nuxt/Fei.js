function cal() {
  ...
  MAXallCairosDMG.innerHTML = Math.ceil(Cairos * 4 * 1.03);
  MINallCairosDMG.innerHTML = Math.ceil(Cairos * 4 * 0.97);
  ...
  MAXallYCairosDMG.innerHTML = Math.ceil(Cairos * 4 * 1.03);
  MINallYCairosDMG.innerHTML = Math.ceil(Cairos * 4 * 0.97);
  ...
  MAXallNCairosDMG.innerHTML = Math.ceil(NCairos * 4 * 1.03);
  MINallNCairosDMG.innerHTML = Math.ceil(NCairos * 4 * 0.97);
  ...
  MAXallGuildBattleDMG.innerHTML = Math.ceil(GuildBattle * 4 * 1.03);
  MINallGuildBattleDMG.innerHTML = Math.ceil(GuildBattle * 4 * 0.97);
  ...
  MAXallYGuildBattleDMG.innerHTML = Math.ceil(GuildBattle * 4 * 1.03);
  MINallYGuildBattleDMG.innerHTML = Math.ceil(GuildBattle * 4 * 0.97);
  ...
  MAXallNGuildBattleDMG.innerHTML = Math.ceil(NGuildBattle * 4 * 1.03);
  MINallNGuildBattleDMG.innerHTML = Math.ceil(NGuildBattle * 4 * 0.97);
  ...
  MAXallArenaDMG.innerHTML = Math.ceil(ARENA * 4 * 1.03);
  MINallArenaDMG.innerHTML = Math.ceil(ARENA * 4 * 0.97);
  ...
  MAXallYArenaDMG.innerHTML = Math.ceil(ARENA * 4 * 1.03);
  MINallYArenaDMG.innerHTML = Math.ceil(ARENA * 4 * 0.97);
  ...
  MAXallNArenaDMG.innerHTML = Math.ceil(NARENA * 4 * 1.03);
  MINallNArenaDMG.innerHTML = Math.ceil(NARENA * 4 * 0.97);
}